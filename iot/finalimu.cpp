...
void loop() {
  ...
  // Debug output
  Serial.print("FallFlag="); Serial.print(fallFlag);
  Serial.print(" SeizureFlag="); Serial.print(seizureFlag);
  Serial.print(" A_g="); Serial.print(amag,2);
  Serial.print(" W_deg/s="); Serial.print(wmag,1);
  Serial.println();
  delay(INT_MS);
}
